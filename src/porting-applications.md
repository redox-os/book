...
- Build instructions in the application or library website tends to be outdated, in case of doubt always prefer the source tarball or repository documentation (commonly a section in the `README` file or `INSTALL` file)
