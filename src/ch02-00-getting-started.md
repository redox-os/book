...
The [Building Redox](./ch02-05-building-redox.html) page has information about configuring your system to build Redox, which is necessary if you want to contribute to the development. The [Advanced Build](./ch08-01-advanced-build.html) page gives a look under the hood of the build process to help you maintain your build environment.
