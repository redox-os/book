...
- All recipe commands (f, r, c, u, cr, ucr) can be run with multiple recipes, just separate them by `,`, e.g. `make f.recipe1,recipe2` will donwload the sources of `recipe1` and `recipe 2`
