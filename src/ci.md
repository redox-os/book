...
The [continuous integration](https://en.wikipedia.org/wiki/Continuous_integration) system helps developers to automate the program testing as the code evolves, as it detects broken things or regressions.

The developer adds a configuration file on the Git repository root with the commands to test the things.
