...
If your software is written in Rust, it will use libstd (Redox Standard Library) to make your software access the Redox system calls.

If your software is written in C/C++ or is a non-Rust program, it will use relibc (Redox C library) to make your software access the Redox system calls.
